<?php
/**
 * Services Post Type creation file.
 *
 * @package bigbang
 */
...
function register_services_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Services', 'Post Type General Name', 'bigbang' ),
		'singular_name'         => _x( 'Service', 'Post Type Singular Name', 'bigbang' ),
		'menu_name'             => __( 'Services', 'bigbang' ),
		'name_admin_bar'        => __( 'Service', 'bigbang' ),
	...
	$args = array(
		'label'                 => __( 'Servicios', 'bigbang' ),
		'description'           => __( 'Services for bigbang', 'bigbang' ),
		'labels'                => $labels,
