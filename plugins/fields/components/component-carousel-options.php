...
acf_add_local_field_group(array(
	...
	'fields' => array(
		...
		array(
			...
			'prepend' => '#',
			'append' => 'slides',
			'key' => 'component_carousel_options_field_desktop_slides_scroll',
			'label' => 'Desktop Slides to scroll',
			'name' => 'desktop_slides_scroll',
			'type' => 'number',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			'default_value' => '<button type=\"button\" class=\"slick-prev\"><i class=\"fa fa-angle-left\"></i></button>',
			'maxlength' => '',
			'placeholder' => '',
			'prepend' => '',
			'append' => '',
		...
		array(
			'default_value' => '<button type=\"button\" class=\"slick-next\"><i class=\"fa fa-angle-right\"></i></button>',
			'maxlength' => '',
			'placeholder' => '',
			'prepend' => '',
			'append' => '',
		...
		array(
			...
			'ui_on_text' => 'Enable',
			'ui_off_text' => 'Disable',
			'key' => 'component_carousel_options_field_parallax',
		...
		array(
			...
			'prepend' => '#',
			'append' => 'slides',
			'key' => 'component_carousel_options_field_mobile_slides_scroll',
			'label' => 'Mobile Slides to scroll',
			'name' => 'mobile_slides_scroll',
			'type' => 'number',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => array(
